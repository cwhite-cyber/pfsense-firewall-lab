...
- [x] Diagram the full lab architecture with pfSense as the segmentation point
...
| `graylog01` (Graylog SIEM) | Log aggregation target | LAN (host-only) - stalled, see graylog-siem-lab |
...
Real errors hit during this build, in the order encountered. See `docs/troubleshooting.md` for full detail (symptom, cause, fix, and how it was verified). Highlights below.
...
- [LibreNMS Network Monitoring Lab](https://github.com/cwhite-cyber/librenms-home-lab.git)
- [Graylog SIEM Build](https://github.com/cwhite-cyber/graylog-siem-lab.git)
